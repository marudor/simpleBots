...
/**
 * Created by marudor on 08/08/14.
 */
@Entity
public class UserAgent {
    ...
    public UserAgent(String userAgent, BrowserType browserType) {
    ...
    public static UserAgent getRandomByType(BrowserType type) {
        Session s = Database.getSession();
        Criteria crit = s.createCriteria(UserAgent.class);
        crit.setProjection(Projections.rowCount());
        int count = ((Number) crit.uniqueResult()).intValue();
        if (0 != count) {
            int index = new Random().nextInt(count);
            crit = s.createCriteria(UserAgent.class);
            return (UserAgent) crit.setFirstResult(index).setMaxResults(1).uniqueResult();
        }
        return null;
    }
    ...
    public static void initialData() {
        ...
        for (String opera : new String[] {
            ...
            s.save(new UserAgent(opera, BrowserType.OPERA));
        ...
        for (String safari :
            ...
            s.save(new UserAgent(safari, BrowserType.SAFARI));
        ...
        s.save(new UserAgent(firefox,BrowserType.FIREFOX));
        ...
        for (String chrome :
            ...
            s.save(new UserAgent(chrome,BrowserType.CHROME));
        ...
        for (String ie :
                new String[] {
                    ...
                    s.save(new UserAgent(ie,BrowserType.IE));
        s.flush();
        s.close();
    }

    public static void deleteByUserAgent(String userAgent) {
        Session s = Database.getSession();
        Object agent = s.createCriteria(UserAgent.class).add(Restrictions.eq("userAgent",userAgent)).uniqueResult();
        s.delete(agent);
        s.flush();
        s.close();
    }
